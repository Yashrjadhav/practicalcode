...
void student::create()
  {
	char ans;
	ofstream fout;
	fout.open("stud.text",ios::out|ios::binary);
	do
	  {
...
void student::display()
  {
	ifstream fin;
	fin.open("stud.text",ios::in|ios::binary);
	fin.seekg(0,ios::beg);
...
void student::Delete()
  {
	...
	pos=search();
	fstream f;
	f.open("stud.text",ios::in|ios::out|ios::binary);
	f.seekg(0,ios::beg);
	if(pos==0)
	  {
		cout<<"\n\tRecord Not Found";
...
/*
/Desktop/ADSL/F$ g++ F23.cpp
/Desktop/ADSL/F$ ./a.out
